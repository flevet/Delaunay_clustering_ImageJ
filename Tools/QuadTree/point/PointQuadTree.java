...
import Tools.QuadTree.AbstractQuadTree;
...
public class PointQuadTree<T> extends AbstractQuadTree<T> {
     ...
     * @return
     */
    public ArrayList<? extends AbstractNodeElement<T>> getElements( Point2D.Double coordinates ) {
    ...
    public ArrayList<? extends AbstractNodeElement<T>> getNeighboringCells(double _cx, double _cy, double _cr) {
        return getNeighboringCells(new Point2D.Double(_cx, _cy), _cr);
    }

    public ArrayList<? extends AbstractNodeElement<T>> getNeighboringCells(Point2D.Double _center, double _cr) {
